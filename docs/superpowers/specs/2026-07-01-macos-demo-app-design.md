...
- 打开后展示 Camera Extension / host / demo mode / 设备可见状态
...
- 独立 target，但复用现有 native host/demo bridge 能力
...
- 新 app 只负责拉起现有 `akvc-host` / `akvc-camera-demo-host`
- 自身不直接调用底层支持代码
...
- [virtualcam/macos/host/AKVCCommandSupport.h](/Users/admir/workspace/virtual-camera/virtualcam/macos/host/AKVCCommandSupport.h)
- [virtualcam/macos/host/AKVCCommandSupport.mm](/Users/admir/workspace/virtual-camera/virtualcam/macos/host/AKVCCommandSupport.mm)
- [virtualcam/macos/host/AKVCSystemExtensionSupport.h](/Users/admir/workspace/virtual-camera/virtualcam/macos/host/AKVCSystemExtensionSupport.h)
- [virtualcam/macos/host/AKVCSystemExtensionSupport.mm](/Users/admir/workspace/virtual-camera/virtualcam/macos/host/AKVCSystemExtensionSupport.mm)
...
- 明确展示 native 错误文本
- 保持与现有 `akvc-host` / `akvc-camera-demo-host` 同一套底层逻辑，方便对照排查
